...
train_counts = counter.transform(train_emails_2.data)
test_counts = counter.transform(test_emails_2.data)

classifier = MultinomialNB()

classifier.fit(train_counts,train_emails_2.target)

print(classifier.score(test_counts,test_emails_2.target))
